...
title.grid(row=0, column=2, columnspan=6)
...
# Tag
tag_title = tk.Label(root, text='Tag', fg='black', font='Helvetica 18')
tag_title.grid(row=10, column=1, columnspan=4)

# Download button
url_button = tk.Button(root, text='Download', font='Helvetica 18 bold', command=download)
url_button.grid(row=10, column=5, columnspan=4)

# Skip button
skip = tk.Button(root, text='Skip', font='Helvetica 18 bold', command=skip)
skip.grid(row=11, column=0, columnspan=1)

# Submit button
submit = tk.Button(root, text='Submit', font='Helvetica 18 bold', command=submit)
submit.grid(row=11, column=9, columnspan=1)

# Tag form field
tag_field = tk.Entry(root)
tag_field.grid(row=11, column=1, columnspan=4)

# Url form field
url_form = tk.Entry(root)
url_form.grid(row=11, column=5, columnspan=4)
