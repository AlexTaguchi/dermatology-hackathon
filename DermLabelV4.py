...
url_button.grid(row=10, column=3, columnspan=4)

# Skip button
skip = tk.Button(root, text='Skip', font='Helvetica 18 bold', command=skip)
skip.grid(row=11, column=0, columnspan=3)

# Submit button
submit = tk.Button(root, text='Submit', font='Helvetica 18 bold', command=submit)
submit.grid(row=11, column=7, columnspan=3)

# Url form field
url_form = tk.Entry(root)
url_form.grid(row=11, column=0, columnspan=10)
